...
key.labels <- c("Pred. model", "Miss. model", "Calib. sampling", "Test inference", "One-time comp.")

results <- results.raw %>%
  pivot_longer(cols=c("t_train", "t_missing", "t_sample_calib", "t_test", "t_universal"), names_to='Key', values_to='Value') %>%
